...
import style from "./pagination-arrow.module.scss";
...
const PaginationArrow: React.FC<TPaginationArrow> = ({isLeft, color, isDisabled}) => {


    return (
        <button className={style.button} disabled={isDisabled}>
            <svg style={{rotate: isLeft ? '180deg' : '0'}} width="46" height="30" viewBox="0 0 46 30" fill="none"
